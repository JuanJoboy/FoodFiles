		...
		(
			...
			(
				onTap: ()
				{
					...
					(
						context,
						MaterialPageRoute(builder: (context) => PageSwitcher(nextPage: FeedPage.filedMeals(restaurantName, locationName, true))) // Clicking on a location shows all the posts that are filtered by restaurant and location
					);
    			},
				child: Padding
				(
